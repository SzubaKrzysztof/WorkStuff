              ...
              value: function () {
                (this.isOpened = !1),
                  ...
                  e._shadow ||
                    ...
                    e._shadow.classList.add("modal__shadow"),
                ...
                document.addEventListener(
                  ...
                  function (e) {
                    ...
                    this.config.closeOnButton &&
                      e.target.closest("[data-modalclose]") &&
                      this.close();
                  }.bind(this)
                ),
              ...
              value: function (t) {
                if (
                  ...
                  (this.openedWindow = this._nextWindows),
                    (this._modalBlock =
                      this.openedWindow.querySelector(".modal__window")),
                    this.config.beforeOpen(this),
                    // this._bodyScrollControl(),
                    e._shadow.classList.add("modal__shadow--show"),
            ...
            },
            {
              ...
              value: function () {
                this.openedWindow.classList.remove("modal--moved"),
                  ...
                  (this._isMoved = !1),
                  e._shadow.classList.remove("modal__shadow--show"),
            ...
            },
            {
              ...
              value: function () {
                if (this.config.backscroll) {
                  ...
                  if (!0 === this.isOpened)
                    return (
                      t.classList.remove("modal__opened"),
                      (t.style.marginRight = ""),
                      e.map(function (e) {
                        e.style.marginRight = "";
                      }),
